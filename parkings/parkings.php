...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <button class="btn btn-default" data-backdrop="false" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Seleccione Ahora</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-tag"></span> <?=$parking_remaining; ?> Tiempo restantes</li>
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> Ksh. <?=$parking_price; ?> Precio por hora</li>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="select<?=$parking_id; ?>">Seleccione este espacio</button>
      </div>
    </div>
  </div>
</div>
...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <button class="btn btn-default" type="button" data-backdrop="false" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Seleccione Ahora</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-tag"></span> <?=$parking_remaining; ?> Tiempo restante</li>
