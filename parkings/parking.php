...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Seleccione ahora</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> <?=$parking_name; ?></li>
          <li class="list-group-item"><span class="glyphicon glyphicon-tags"></span> <?=$parking_slot; ?> Tiempo totale </li>
          <li class="list-group-item"><span class="glyphicon glyphicon-tag"></span> <?=$parking_slot; ?> Tiempo restante</li>
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> Ksh. <?=$parking_price; ?> Precio por hora</li>
          <li class="list-group-item total"  ><div id="total<?=$parking_id; ?>"> Ksh.<?=$parking_slot; ?> Costo total</div></li>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Seleccione este espacio</button>
      </div>
    </div>
  </div>
</div>
