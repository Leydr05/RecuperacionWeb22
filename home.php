...
<body>
    <div >
      <div class="container">
         ...
         <div class="col-md-8">
                 <center><h1 class="colors"><a href="home.php" style="text-decoration: none; color:white;">Parqueo</a></h1></center>
           ...
           <ul>
             <li class="list-group-item" id="requests">
                <div class="thumbnail">
                      ...
                      <center>
                        <h3><?=$name?></h3>
                        <p>(<?=$email?>)</p>
                        <p><i id="#online" class="fa fa-circle" aria-hidden="true"></i> En línea</p>
                        <p><a href="logout.php"><i class="fa fa-power-off" aria-hidden="true"></i> cerrar sesión</a></p>
                        </center>
                      </div>
                    </div>
             </li>
             ...
             <li class="list-group-item">
               <select class="form-control" onchange="filter_park()" id="street">
                 ...
                 <option value="Calle 5">Calle 1</option>
                 <option value="Calle 25">Calle 2</option>
                 <option value="Calle 1">Calle 3</option>
               </select>
             </li>

             <li class="list-group-item" id="requests"><a><span class="glyphicon glyphicon-envelope"></span> Mensajes</a></li>
