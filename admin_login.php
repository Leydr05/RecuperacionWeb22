	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="admin_login.php" method="post">
		        <h2 class="form-login-heading">Regístrate</h2>
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" href="index.php" name='admin_login'  type="submit"><i class="fa fa-lock"></i> REGISTRARSE</button>
		          <!-- Modal -->
