      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <ul class="left-links">
                      <li><a  href="blank.php"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Agregar nuevo Parqueo</a></li>
                      <li><a  href="basic_table.php"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Parqueos</a></li>
