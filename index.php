...
var regMail = /^([_a-zA-Z0-9-]+)(\.[_a-zA-Z0-9-]+)*@([a-zA-Z0-9-]+\.)+([a-zA-Z]{2,3})$/;
   var status = document.getElementById("emailstatus");
    ...
    {
    document.getElementById("emailstatus").innerHTML    = "<span class='warning'>La dirección de correo electrónico no es válida.</span>";
    ...
    {
    document.getElementById("emailstatus").innerHTML  = "<span class='valid'>Ela dirección de correo es válida!</span>";
      ...
      <div class="container">
         ...
         <div class="col-md-4">
               <div class="page-header">
                 <center><h1 class="colors">Parqueo</h1></center>
               </div>
         </div>
         <div class="col-md-4"></div>
      </div>
...
<button type="submit" id="regBtn" class="form-control" name="register">crear una cuenta</button>
        </div>
        </form>
      </div>
